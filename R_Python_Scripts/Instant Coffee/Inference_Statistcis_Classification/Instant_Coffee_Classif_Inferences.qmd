...
```{r}
df <- read_excel('summary_model_results_classification_instant _coffee.xlsx',sheet = 'Model')
...
ggplot(data = df, aes(x = Model, y = Unbalanced_Data_MCC))+
  ...
  labs(title = 'Model Performance Comparison for Imbalanced Data (Instant Coffee)')+
  ylab('MCC Score')+
  theme_bw()+
  theme(
...
ggplot(data = df, aes(x = Model, y = Balanced_Data_MCC))+
  geom_boxplot(aes(fill = Model))+
  labs(title = 'Model Performance Comparison for SMOTE Data (Instant Coffee)')+
  ylab('MCC Score')+
  theme_bw()+
  theme(
    axis.title.x = element_text(color = "black", size = 9),  
...
df %>% ggplot(aes(x = Pre_processing, y = Unbalanced_Data_MCC))+
  ...
  labs(title = 'Preprocessing-Imbalanced Data Instant Coffee',x = 'Spectral Pre-processing')+
  ylab('MCC Score')+
  theme_bw()+
  theme(
    axis.title.x = element_text(color = "black", size = 9),  
...
df %>% ggplot(aes(x = Pre_processing, y = Balanced_Data_MCC))+
  geom_boxplot(aes(fill = Pre_processing))+
  labs(title = 'Preprocessing-SMOTE Data Instant Coffee', x = 'Spectral Pre-processing')+
  ylab('MCC Score')+
  theme_bw()+
  theme(
    axis.title.x = element_text(color = "black", size = 9),  
...
```{r}
df_bal <- read_excel('summary_model_results_classification_Instant _coffee.xlsx', sheet='data_balance')
...
df_bal %>% ggplot(aes(x = data_balance, y = Balanced_Accuracy, fill = data_balance)) +
  geom_boxplot() +
  labs(title = "Impact of SMOTE on Balanced Accuracy (Instant Coffee)",
 ...
 theme(
    ...
    legend.backInstant = element_rect(fill = "white", color = "black"),  
...
ggsave("SMOTE_Data_Balance_Instant_Coffee.png", width = 6, height = 4, dpi = 600, bg = "white")
...
df_bal %>% ggplot(aes(x = data_balance, y = Specificity, fill = data_balance)) +
  geom_boxplot() +
  labs(title = "Impact of SMOTE on Specificity (Instant Coffee)",
       y = "Model Specificity")+
 theme(
    axis.title.x = element_blank(),  
    axis.text.x = element_blank(),   
...
svm %>% ggplot(aes(x = Model, y = Specificity, fill = Model)) +
  geom_boxplot() +
  labs(title = "Impact of SVM-SMOTE on Specificity (Instant Coffee)",
       y = "Model Specificity")+
 theme(
    axis.title.x = element_blank(),  
    axis.text.x = element_blank(),   
...
lda %>% ggplot(aes(x = Model, y = Specificity, fill = Model)) +
  geom_boxplot() +
  labs(title = "Impact of LDA-SMOTE on Specificity (Instant Coffee)",
       y = "Model Specificity")+
 theme(
    axis.title.x = element_blank(),  
    axis.text.x = element_blank(),   
...
rf %>% ggplot(aes(x = Model, y = Specificity, fill = Model)) +
  geom_boxplot() +
  labs(title = "Impact of RF-SMOTE on Specificity (Instant Coffee)",
       y = "Model Specificity")+
 theme(
    axis.title.x = element_blank(),  
    axis.text.x = element_blank(),   
...
ggsave("SMOTE_Data_Preprocessing_Balance_Instant_Coffee_Specifity.png", width = 6, height = 4, dpi = 600, bg = "white")
```
...
ggsave("SMOTE_Data_Preprocessing_Balance_Instant_Coffee_Accuracy.png", width = 6, height = 4, dpi = 600, bg = "white")
```
...
```{r}
df_time <- read_excel('model_training_time_instant.xlsx')
head(df_time)
